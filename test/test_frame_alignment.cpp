...
class FACTOR_TEST : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    auto pt0_target_pixel = target_frame.ComputePointPixelLocation(p1_pt0);
    auto pt1_target_pixel = target_frame.ComputePointPixelLocation(p1_pt1);
    auto pt2_target_pixel = target_frame.ComputePointPixelLocation(p1_pt2);
    auto pt3_target_pixel = target_frame.ComputePointPixelLocation(p1_pt3);

    std::vector<Eigen::Vector2d> host_pixel_locations(4);
    host_pixel_locations[0] = p0_pixel_location;
    host_pixel_locations[1] = p1_pixel_location;
    host_pixel_locations[2] = p2_pixel_location;
    host_pixel_locations[3] = p3_pixel_location;
    
    std::vector<Eigen::Vector2d> target_pixel_locations(4);
    target_pixel_locations[0] = pt0_target_pixel;
    target_pixel_locations[1] = pt1_target_pixel;
    target_pixel_locations[2] = pt2_target_pixel;
    target_pixel_locations[3] = pt3_target_pixel;
